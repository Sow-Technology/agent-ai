...
export async function POST(request: NextRequest) {
  try {
    ...
    const decryptedData = await decryptSecureData(body.encryptedData, body.dataKey);
...
async function decryptSecureData(encryptedData: string, key: string): Promise<any> {
