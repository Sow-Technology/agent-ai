...
import { chatAboutAudit, type AuditChatInput, type AuditChatOutput, type ChatMessage } from '@/ai/flows/audit-chat-flow';
...
export function AuditChatbot({ auditSummary, auditTranscription, className }: AuditChatbotProps) {
  ...
  const handleSendMessage = async (event?: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const result: AuditChatOutput = await chatAboutAudit(flowInput);
