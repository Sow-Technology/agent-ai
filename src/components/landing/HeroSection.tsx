...
export const HeroSection = () => {
  ...
  return (
    <section ref={containerRef} className="relative min-h-[140vh] flex flex-col items-center pt-32 overflow-hidden bg-black perspective-2000">
      ...
      <div className="absolute inset-0 z-0 opacity-20 pointer-events-none overflow-hidden mix-blend-color-dodge">
          <div className="absolute w-[200%] h-[150%] left-[-50%] bottom-[-20%] bg-[linear-gradient(to_right,rgba(255,255,255,0.05)_1px,transparent_1px),linear-gradient(to_bottom,rgba(255,255,255,0.05)_1px,transparent_1px)] bg-[size:3rem_3rem] [mask-image:radial-gradient(ellipse_60%_50%_at_50%_0%,#000_70%,transparent_100%)] animate-grid-flow" 
      ...
      <div className="z-10 container px-4 sm:px-6 flex flex-col items-center text-center space-y-10 mb-24">
        ...
        <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
          <Badge variant="outline" className="bg-white/[0.03] border-white/[0.08] text-primary-foreground/80 px-4 py-1.5 rounded-full uppercase tracking-[0.2em] text-[10px] font-medium hover:bg-white/[0.08] transition-colors cursor-default backdrop-blur-md">
        ...
        <motion.h1
          ...
          className="text-5xl md:text-7xl lg:text-8xl font-bold tracking-tighter text-white max-w-6xl z-10"
        >
          Audit 100% of calls. <br />
          <span className="text-transparent bg-clip-text bg-gradient-to-br from-white via-white to-white/40">Zero human bias.</span>
        </motion.h1>
        ...
        <motion.p
          ...
          className="text-lg md:text-xl text-muted-foreground/80 max-w-2xl leading-relaxed z-10 font-light tracking-wide"
        >
      ...
      >
        <div className="relative w-full h-full transform-style-3d">
            ...
            <motion.div 
                style={{ y: yMid }}
                className="absolute top-[20%] -right-16 w-80 bg-black/80 backdrop-blur-xl border border-white/10 rounded-xl p-5 shadow-[0_30px_60px_-10px_rgba(0,0,0,0.8)] z-20 hidden md:block hover:border-white/20 transition-colors duration-300"
            >
                <div className="flex items-center gap-3 mb-3">
                    ...
                    <div className="text-white font-medium tracking-tight">Fatal Error Detected</div>
                </div>
                ...
                <p className="text-xs text-muted-foreground leading-relaxed">Agent missed mandatory verification disclosure in Step 3.</p>
            </motion.div>

            <motion.div 
                 style={{ y: yMid }}
                 className="absolute bottom-[20%] -left-16 w-72 bg-black/80 backdrop-blur-xl border border-white/10 rounded-xl p-5 shadow-[0_30px_60px_-10px_rgba(0,0,0,0.8)] z-20 hidden md:block hover:border-white/20 transition-colors duration-300"
            >
                 <div className="flex justify-between items-end mb-3">
                     <span className="text-muted-foreground text-sm font-medium">Audit Score</span>
            ...
            <motion.div 
                style={{ y: yTop }}
                className="absolute -top-6 left-[40%] px-6 py-3 bg-[#0A0A0A] text-white rounded-full shadow-[0_0_50px_-10px_rgba(99,102,241,0.3)] z-30 font-semibold border border-white/[0.08] hidden md:flex items-center gap-3 backdrop-blur-2xl hover:scale-105 transition-transform duration-300"
            >
