...
const FeatureCard = ({ className, children, visuals, noPadding = false }: { className?: string; children: React.ReactNode; visuals?: React.ReactNode; noPadding?: boolean }) => (
    <motion.div 
        whileHover={{ y: -5 }}
        className={cn(
            "relative group overflow-hidden rounded-3xl bg-[#080808] border border-white/[0.08] hover:border-white/[0.15] transition-all duration-500 shadow-2xl",
            className
        )}
    >
        ...
        <div className={cn(
            ...
            noPadding ? "" : "p-8",
            visuals ? "bg-gradient-to-b from-[#0A0A0A]/90 via-[#0A0A0A]/60 to-[#0A0A0A]/90" : ""
        )}>
            {children}
        </div>

        {/* Highlight Borders */}
        <div className="absolute inset-0 border border-white/[0.05] rounded-3xl pointer-events-none" />
    </motion.div>
);

export const FeaturesSection = () => {
    return (
        <section className="relative py-32 container px-4 sm:px-6 z-10 bg-black">
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-6 h-auto md:h-[650px] mb-6">
                ...
                <FeatureCard className="md:col-span-8 md:row-span-4" visuals={<ScannerVisual />}>
                    <div className="flex items-start justify-between">
                         ...
                         <div className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-black/40 border border-white/10 backdrop-blur-xl">
                             ...
                             <span className="text-xs font-mono text-white/80">LIVE MONITORING</span>
                         </div>
                    </div>
                    <div className="mt-auto">
                        <h3 className="text-3xl font-semibold text-white mb-2">Omniscient Coverage</h3>
                ...
                <FeatureCard className="md:col-span-4 md:row-span-2" visuals={<PulseVisual />}>
                    ...
                    <div className="mt-auto">
                        <h3 className="text-xl font-semibold text-white mb-1">Zero Latency</h3>
                ...
                <FeatureCard className="md:col-span-4 md:row-span-2" visuals={<TerminalVisual />}>
                    ...
                    <div className="mt-auto relative z-20 max-w-[60%]">
                        <h3 className="text-xl font-semibold text-white mb-1">Deep Diagnostics</h3>
                 ...
                 <FeatureCard className="group hover:bg-white/[0.02]" noPadding>
                     <div className="p-6 flex flex-col h-full justify-between">
                        <div className="flex items-center gap-4 mb-4">
                             ...
                             <span className="text-lg font-medium text-white">Smart TNIs</span>
                        </div>
                 ...
                 <FeatureCard className="group hover:bg-white/[0.02]" noPadding>
                    <div className="p-6 flex flex-col h-full justify-between">
                         <div className="flex items-center gap-4 mb-4">
                             ...
                             <span className="text-lg font-medium text-white">Sentiment AI</span>
                         </div>
                        <p className="text-muted-foreground/70 text-sm leading-relaxed mb-4">
